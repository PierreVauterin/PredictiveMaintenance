...
All pages of the application with all their features
A graphical update (as the interface is currently not at its prime)
A saving system, to store your settings and models preferences
A lot of machine learning algorithms you can tweak to optimize their training on your dataset
A dataset handling, to display and train models on your data, to get the results you are looking for
